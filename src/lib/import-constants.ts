...
export const TARGET_FIELDS: TargetFieldDef[] = [
  { value: "first_name", label: "Nombre", required: true, group: "persona" },
  { value: "last_name", label: "Apellidos", group: "persona" },
  { value: "dni", label: "DNI / NIE", required: true, group: "persona" },
  { value: "email", label: "Email", required: true, group: "persona" },
  { value: "phone", label: "Teléfono", required: true, group: "persona" },
